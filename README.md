...
在子module的启动类上出现【Cannot access org.springframework.context.ConfigurableApplicationContext】这个错误时，通常是由于 模块化问题 或 依赖冲突 导致的，特别是当你使用 Java 9 或更高版本，或者项目依赖版本不匹配时。
